...
**R:** Você está usando HTTP. A câmera **só funciona com HTTPS**. Use: `https://install-pulse.preview.emergentagent.com`
...
1. Cole na barra de endereço:
   ```
   chrome://settings/content/siteDetails?site=https://install-pulse.preview.emergentagent.com
   ```
2. Role até "Câmera"
