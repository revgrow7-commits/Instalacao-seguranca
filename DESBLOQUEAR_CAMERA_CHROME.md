...
**R:** Você está usando HTTP. A câmera **só funciona com HTTPS**. Use: `https://work-monitor-5.preview.emergentagent.com`
...
1. Cole na barra de endereço:
   ```
   chrome://settings/content/siteDetails?site=https://work-monitor-5.preview.emergentagent.com
   ```
2. Role até "Câmera"
